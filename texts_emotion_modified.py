...
#add file importing and then analysising and also some other functions
...
file_button = tk.Button(root, text = "attach file", font = ("Arial",15), command = file)
file_button.pack(padx = 40, pady = 15)
